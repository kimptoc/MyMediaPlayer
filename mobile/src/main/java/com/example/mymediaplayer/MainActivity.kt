...
class MainActivity : ComponentActivity() {
    ...
    private fun MainAppContent(uiState: MainUiState) {
        MainScreen(
            ...
            onOpenSongPlaylists = viewModel::openSongPlaylistsDialog,
            onToggleSongInPlaylist = viewModel::toggleSongPlaylistRemoval,
            onConfirmSongPlaylistsChanges = viewModel::confirmSongPlaylistsDialogChanges,
            onCancelSongPlaylistsDialog = viewModel::cancelSongPlaylistsDialog,
    ...
    private fun sendPlaylistsToServiceIfNeeded(playlists: List<PlaylistInfo>) {
        ...
        val names = playlists.mapTo(ArrayList<String>(playlists.size)) { it.displayName }
        val bundle = Bundle().apply {
